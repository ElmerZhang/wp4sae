...
1. 分享评论或文章：评论的同时将文章分享到各大社交网站，让评论者的好友也来参与评论，带来回访流量
1. 数据实时本地保存：评论内容实时保存到您的WordPress本地服务器，并可将多说评论数据导出，数据永远归你所有

**让你的评论“鲜活”起来！**

= 评论框原来可以如此精彩 =
* 多账号登录：让网站的用户轻松加入你的社区参与讨论，支持新浪微博(Sina Weibo)、QQ(Qzone)、人人(Renren)、豆瓣(Douban)、开心网(Kaixin001)、网易微博(Netease)、搜狐微博(Sohu)、百度(Baidu)账号和邮箱登录，更多登录方式陆续添加中。
...
* IntenseDebate
* livefyre
* youyan (youyan-social-comment-system)
* pinglunla
* denglu
* wp-connect
